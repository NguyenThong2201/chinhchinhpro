...
<div class="span9" id="content">
    ...
    <div class="block">
        ...
        <div class="block-content collapse in">
            <div class="span12">
                <form class="form-horizontal" id="form" action="admin/loaisanpham/them-lsp" method="POST" enctype="multipart/form-data">
                  <fieldset>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" class="span6" data-provide="typeahead" value="{{old('tenloai')}}" name="tenloai" />
                      </div>
                    </div>
                    <div class="control-group">

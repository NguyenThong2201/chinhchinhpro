...
<div class="banner1">
    <div class="container">
        <h3><a href="{{route('trang-chu')}}">Trang Chủ</a> / <span>Thời Trang Nữ</span></h3>
    </div>
</div>
<!--banner-->
<!--content-->
<div class="content">
	<div class="products-agileinfo">
			<h2 class="tittle">Thời Trang {{ (Request::is('/nam') ? 'Nam' : 'Nữ') }}</h2>
		<div class="container">
			<div class="product-agileinfo-grids w3l">
				...
				<div class="col-md-9 product-agileinfon-grid1 w3l">
					...
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						...
						<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><img src="/home/images/menu1.png"></a></li>
						<li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile"><img src="/home/images/menu.png"></a></li>
						</ul>
						<div id="myTabContent" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
								<div class="product-tab">
									@foreach($productswomen as $prwm)
									<div class="col-md-4 arrival-grid simpleCart_shelfItem bt-product">
					                    <div class="grid-arr">
					                        <div  class="grid-arrival">
					                            <figure>
					                                <a href="{{route('chi-tiet',$prwm->name_sale)}}">
					                                    <div class="grid-img">
					                                        <img  src="/home/images/p27.jpg" class="img-responsive" alt="">
					                                    </div>
					                                    <div class="grid-img">
					                                        <img  src="/home/images/{{$prwm->image}}" class="img-responsive"  alt="">
					                                    </div>
					                                </a>
					                            </figure>
					                        </div>
					                        ...
					                        @if($prwm->unit_price - $prwm->promotion_price > 0)
					                        <div class="ribben1">
					                            <p>SALE</p>
					                        </div>
					                        @endif
					                        <div class="women mgB10">
					                            <h6><a href="{{route('chi-tiet',$prwm->name_sale)}}">{{$prwm->name}}</a></h6>
					                            <p>
					                                @if($prwm->unit_price - $prwm->promotion_price > 0)
					                                <del>{{number_format($prwm->unit_price)}}</del>
					                                @endif
					                                <em class="item_price">{{number_format($prwm->promotion_price)}}đ</em>
					                            </p>
					                            <a href="#" data-toggle="modal" data-target="#view-{{$prwm->id}}" data-text="Add To Cart" class="my-cart-b item_add">Đặt Mua</a>
					                        </div>
					                    </div>
					                </div>
					                @include('page.modals',['pr'=>$prwm])
									@endforeach
									<div class="clearfix"></div>
									<div class="row">{{$productswomen->links()}}</div>
								</div>
							</div>
							<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
								@foreach($productswomen as $prwm)
								<div class="product-tab1 mgB20">
									<div class="col-md-4 product-tab1-grid ">
										<div class="grid-arr">
											<div  class="grid-arrival">
												<figure>		
													<a href="{{route('chi-tiet',$prwm->name_sale)}}" class="new-gri">
														<div class="grid-img">
									...
									<div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
										<div class="women">
											...
											<a href="#"  data-toggle="modal" data-target="#view-{{$prwm->id}}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
										</div>
									</div>
									<div class="clearfix"></div>
								</div>
